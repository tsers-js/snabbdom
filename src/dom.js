...
var domApi = require('snabbdom/htmldomapi');
...
function init(modules, api) {
  ...
  function patchVnode(oldVnode, vnode, insertedVnodeQueue) {
    ...
    // we don't want the diffing algorithm to mutate our existing vnodes which
    // might happen if we e.g. remove item from the rendered list (other list
    // elements are "shifted") - oldVnode and vnode have the same referenced object
    // and because the diffing algorithm mutates the new vnode, those mutations
    // reflect directly to old vnode as well (which is not wanted!)
    //
